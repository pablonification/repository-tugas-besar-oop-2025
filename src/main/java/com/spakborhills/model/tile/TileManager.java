...
//        }
    ...
    public void draw(Graphics2D g2) {
        ...
        while (worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow) {
            ...
            int screenX = worldX - gp.player.worldX + gp.playerView.screenX;
            int screenY = worldY - gp.player.worldY + gp.playerView.screenY;

            if(worldX + gp.tileSize > gp.player.worldX - gp.playerView.screenX
                    && worldX - gp.tileSize < gp.player.worldX + gp.playerView.screenX
                    && worldY + gp.tileSize > gp.player.worldY - gp.playerView.screenY
                    && worldY - gp.tileSize < gp.player.worldY + gp.playerView.screenY
            ) {
